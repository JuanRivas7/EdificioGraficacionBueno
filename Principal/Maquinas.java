...
public class Maquinas {
    ...
    public static SharedGroup crearAmasadora() {
        ...
        Box base = new Box(0.08f, 0.02f, 0.08f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Cylinder cuerpo = new Cylinder(0.06f, 0.1f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Box tapa = new Box(0.07f, 0.01f, 0.07f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Cylinder brazo = new Cylinder(0.01f, 0.08f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Box paleta1 = new Box(0.03f, 0.004f, 0.01f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Box paleta2 = new Box(0.01f, 0.004f, 0.03f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
        ...
        Box panel = new Box(0.03f, 0.02f, 0.002f, paraTextura, textura.crearTexturas("metalSilla.jpg"));
...
//        
//        // Cuerpo principal (reducido 5 veces)
//        Box cuerpo = new Box(0.1f, 0.16f, 0.08f, paraTextura, textura.crearTexturas("refrigerador.jpg"));
//        Transform3D tCuerpo = new Transform3D();
...
//        Box puerta = new Box(0.09f, 0.15f, 0.004f, paraTextura, textura.crearTexturas("puerta_refri.jpg"));
...
//        
//        // Cuerpo principal (reducido 5 veces)
//        Box cuerpo = new Box(0.12f, 0.14f, 0.1f, paraTextura, textura.crearTexturas("horno_industrial.jpg"));
//        Transform3D tCuerpo = new Transform3D();
...
//        
//        // Panel de control (reducido 5 veces)
//        Box panel = new Box(0.03f, 0.02f, 0.002f, paraTextura, textura.crearTexturas("panel_horno.jpg"));
//        Transform3D tPanel = new Transform3D();
...
//        Cylinder chimenea = new Cylinder(0.02f, 0.06f, paraTextura, textura.crearTexturas("metal_oxidado.jpg"));
...
//        Box cuerpo = new Box(0.08f, 0.06f, 0.06f, paraTextura, textura.crearTexturas("acero.jpg"));
//        Transform3D tCuerpo = new Transform3D();
...
//        Box banda = new Box(0.07f, 0.01f, 0.05f, paraTextura, textura.crearTexturas("banda_transportadora.jpg"));
...
//        
//        // Panel de control (reducido 5 veces)
//        Box panel = new Box(0.03f, 0.02f, 0.01f, paraTextura, textura.crearTexturas("panel_control.jpg"));
//        Transform3D tPanel = new Transform3D();
